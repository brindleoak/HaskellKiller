...
/* package killer-0.1.0.0 */
#ifndef VERSION_killer
#define VERSION_killer "0.1.0.0"
#endif /* VERSION_killer */
#ifndef MIN_VERSION_killer
#define MIN_VERSION_killer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_killer */
...
#define CURRENT_COMPONENT_ID "killer-0.1.0.0-inplace-killer"
